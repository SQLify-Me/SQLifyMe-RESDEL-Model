...
def parse_option():
    ...
    parser.add_argument('--table_path', type = str, default = "G:/RedSql/RESDSQL-main/data/spider/tables.json")
    parser.add_argument('--input_dataset_path', type = str, default = "G:/RedSql/RESDSQL-main/data/spider/train_spider.json", 
                        help = '''
                            options:
                                G:/RedSql/RESDSQL-main/data/spider/train_spider.json
                                G:/RedSql/RESDSQL-main/data/spider/dev.json
                            ''')
    parser.add_argument('--natsql_dataset_path', type = str, default = "G:/RedSql/RESDSQL-main/NatSQL/NatSQLv1_6/train_spider-natsql.json", 
                        help = '''
                            options:
                                G:/RedSql/RESDSQL-main/NatSQL/NatSQLv1_6/train_spider-natsql.json
                                G:/RedSql/RESDSQL-main/NatSQL/NatSQLv1_6/dev-natsql.json
                            ''')
    parser.add_argument('--output_dataset_path', type = str, default = "G:/RedSql/RESDSQL-main/data/pre-processing/preprocessed_dataset.json", 
                        help = "the filepath of preprocessed dataset.")
    parser.add_argument('--db_path', type = str, default = "G:/RedSql/RESDSQL-main/data/spider/database", 
...
def main(opt):
    ...
    with open('D:/mohamed/REDSQL/RESDSQL-main/RESDSQL-main/demo/preprocessed_data/preprocessed_test_natsql.json', "w") as f:
