...
def _train(opt):
    ...
    text2sql_tokenizer = AutoTokenizer.from_pretrained("Salesforce/codet5p-220m-bimodal")
   ...
   # model_class = MT5ForConditionalGeneration if "mt5" in opt.model_name_or_path else T5ForConditionalGeneration
    ...
    for epoch in range(opt.epochs):
        ...
        for batch in train_dataloder:
            ...
            # if train_step % num_checkpoint_steps == 0 and epoch >= 4:
...
def _test(opt):
    ...
    model_path = "D:/mohamed/REDSQL/RESDSQL-main/RESDSQL-main/models/text2natsql-t5-base/checkpoint-14352"
            
    tokenizer = T5TokenizerFast.from_pretrained(model_path)
    # model = AutoModelForSeq2SeqLM.from_pretrained(opt.save_path,trust_remote_code=True)
    #model = AutoModelForSeq2SeqLM.from_pretrained(r"D:/mohamed/REDSQL/RESDSQL-main/RESDSQL-main/models/Code-T5-Bimodal/checkpoint-8750",trust_remote_code=True)
